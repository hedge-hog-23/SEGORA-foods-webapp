  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="usersales.php">Sales</a></li>
        <li>
   ...
   <a href = "index.html"> <button style = "float:right;">Log-out</button> </a>
      <button style = "float:right;">Admin: <?php echo $_SESSION['username'];?></button>
